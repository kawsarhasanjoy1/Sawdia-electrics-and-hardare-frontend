...
const BrandsPage = () => {
  ...
  const { data, isFetching } = useGetAllBrandQuery(query); // query enables search & pagination
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (row: any) => <span>{row?.categoryId?.name}</span>,
    },
    {
      key: "status",
      header: "Status",
  ...
  return (
    <div className="p-6 bg-gray-50">
      ...
      {isFetching ? (
        ...
        <NotFound message="No brands exist at this moment" />
      )}
