  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Link href={`${user?.role}/products/create-product`} className="bg-gradient-to-r from-blue-500 to-blue-400 p-6 rounded-xl shadow text-white hover:scale-105 transform transition">
          <h3 className="text-lg font-semibold mb-2">Add New Product</h3>
          <p  className="text-sm opacity-90">
            Create and manage new products in your inventory.
          </p>
        </Link>
        <Link href={`${user?.role}/orders`} className="bg-gradient-to-r from-green-500 to-green-400 p-6 rounded-xl shadow text-white hover:scale-105 transform transition">
          <h3 className="text-lg font-semibold mb-2">View Orders</h3>
          <p className="text-sm opacity-90">
            Check all recent orders and update their status.
          </p>
        </Link>
        <Link href={`${user?.role}/users`} className="bg-gradient-to-r from-purple-500 to-purple-400 p-6 rounded-xl shadow text-white hover:scale-105 transform transition">
